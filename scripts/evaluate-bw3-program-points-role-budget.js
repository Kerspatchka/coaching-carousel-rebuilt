/* Evaluate E1B against the existing native EOS reference fixture. */
'use strict';
...
async function main() {
  ...
  const report = {
    ...
    expectedPersistentDelta: { remainingProgramPoints: AMOUNT, staffProgramPointsSpent: -AMOUNT, headCoachProgramPointBudget: -AMOUNT },
