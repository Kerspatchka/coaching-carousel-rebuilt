/* Evaluate E1E against the existing native EOS reference fixture. */
'use strict';
...
async function main() {
  ...
  const pass = result.test.remaining === result.reference.remaining + AMOUNT &&
    ...
    result.test.coachContractGoals === result.reference.coachContractGoals + AMOUNT &&
